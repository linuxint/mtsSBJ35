...
import com.devkbil.mtssbj.GeoPoint;
import com.devkbil.mtssbj.Person;
...
import static com.devkbil.mtssbj.SSLUtils.createContextFromCaCert;
import static com.devkbil.mtssbj.SSLUtils.createTrustAllCertsContext;
...
class EsClientIT {
    ...
    static void startOptionallyTestContainers() throws IOException {
        ...
        if(client == null) {
            ...
            props.load(EsClientIT.class.getResourceAsStream("/application.properties"));
