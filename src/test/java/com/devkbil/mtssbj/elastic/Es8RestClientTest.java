...
public class Es8RestClientTest {
    public static void main(String[] args) {
        ...
        credentialsProvider.setCredentials(AuthScope.ANY, new UsernamePasswordCredentials("elastic", "manager"));
        // Create a Java REST client by using the builder and configure HttpClientConfigCallback for the HTTP client.
        // Specify the public endpoint of the Elasticsearch cluster. You can obtain the endpoint from the Basic Information page of the Elasticsearch cluster in the Elasticsearch console.
        ...
        // Create an alias named foo and assign the alias to the index on which write operations need to be performed. This way, all write operations, including indexing, updating, and deleting documents, are automatically routed to the index that uses the alias.
        try {
            // Create an index.
            ...
            // View information about all indexes. The information includes the health status, running status, index names, index IDs, number of primary shards, and number of replica shards.
