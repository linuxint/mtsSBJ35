    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            ...
            <c:if test='${signDocInfo.userno==sessionScope.userno and signDocInfo.docstatus<=1}'>
                ...
                <button class="btn btn-outline btn-primary" onclick="fn_moveToURL('signDocCancel?docno=<c:out value="${signDocInfo.docno}"/>', '회수')"><s:message code="common.btnCollect"/></button>
            </c:if>
