                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                            ...
                            <div class="col-lg-8">
                                <c:forEach var="listview" items="${sstypelist}" varStatus="status">
                                    <label style="margin-right: 5px"><input type="radio"
                                                                            <c:if test='${listview.codecd==schInfo.sstype}'>checked</c:if>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-lg-8">
                                <label style="margin-right: 5px"><input type="radio"
                                                                        <c:if test='${schInfo.ssisopen=="Y"}'>checked</c:if>
                                                                        id="ssisopen" name="ssisopen" value="Y"> 공개</label>
                                <label style="margin-right: 5px"><input type="radio"
                                                                        <c:if test='${schInfo.ssisopen=="N"}'>checked</c:if>
