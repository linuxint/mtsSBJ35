...
<link rel="stylesheet" type="text/css" href="js/easyui/easyui.css?v=${timestamps}">
    <script>

        $(function () {

            var b = {
                "total":<c:out value="${listview.size()}" />, "rows": [
                    <c:forEach var="listview" items="${listview}" varStatus="status">
                    {
                        ...
                        <c:if test="${listview.tsparent!=null}">, "_parentId": "<c:out value="${listview.tsparent}" />"</c:if>
        ...
        function formatProgress(value, row) {
            ...
            */
            ...
            var statusMsg = {
                "gray": "<s:message code="project.gray"/>", "red": "<s:message code="project.red"/>", "green": "<s:message code="project.green"/>"
