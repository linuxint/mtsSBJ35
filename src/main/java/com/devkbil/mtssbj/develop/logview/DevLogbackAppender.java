 ...
 * {@code DevLogbackAppenderService}와 통합합니다.
 * 로그 이벤트를 문자열 형식으로 변환하기 위해 인코더를 사용합니다.
 *
 * @param <E> 이 Appender가 처리하는 로그 이벤트의 타입
 */
@RequiredArgsConstructor
public class DevLogbackAppender<E> extends UnsynchronizedAppenderBase<E> {

    private final DevLogbackAppenderService<E> devLogbackAppenderService;
     ...
     * 인코딩된 메시지와 이벤트 객체를 모두 {@code DevLogbackAppenderService}에 저장을 위해 전달합니다.
